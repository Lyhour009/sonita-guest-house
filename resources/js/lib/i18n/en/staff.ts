export const staff = {
    ...
    maintenance: {
        ...
        subtitle: 'Track, assign, and resolve reported room issues.',
        ...
        emptyDescription: 'Reported issues will show up here for review.',
        showingCount: 'Showing {{shown}} of {{total}} requests',
    ...
    reservations: {
        ...
        table: {
            ...
            returningGuest: 'Returning guest · {{count}} stays',
        },
        today: {
